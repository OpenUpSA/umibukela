...
urlpatterns = patterns(
    ...
    url(r'^programme/(?P<programme_slug>[\w-]+)/story$',
        'umibukela.views.programme_story',
        name='programme_story'),
    url(r'^programme/story/(?P<story_slug>[\w-]+)$',
        'umibukela.views.story_detail',
        name='story_detail'),
    url(r'^programme/results/(?P<programme_slug>[\w-]+)/(?P<cycle_id>\d+)$',
        'umibukela.views.programme_result_cycle',
        name='programme_cycle_result'),
    url(r'^programme/submission/results/(?P<programme_slug>[\w-]+)/(?P<cycle_id>\d+)$',
        'umibukela.views.get_submission_count',
        name='programme_cycle_result'),
    url(r'^programme/datastudio/results/(?P<programme_slug>[\w-]+)/(?P<cycle_id>\d+)$',
        'umibukela.views.get_datastudio_cycle',
        name='datastudio_cycle'),
    url(r'^programme/community/results/(?P<programme_slug>[\w-]+)/(?P<cycle_id>\d+)$',
        'umibukela.views.get_community_cycle',
        name='programme_cycle_result'),
    ...
    url(r'^sites/(?P<site_slug>[\w-]+)/results/(?P<result_id>\d+)$',
        ...
        name='site-result'),
    url(r'^sites/(?P<site_slug>[\w-]+)/results/combined$',
        'umibukela.views.site_result_combined',
        name='site-result-combined'),
